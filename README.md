...
With the text files in working directory you can save a number which will offset its value in the emulation.

## The [anomaly checking program](https://github.com/jakob-ha/pop-p1/blob/main/riverstatsanomaly.py)
